    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">Crea una nueva factura</p>
        </div>
      </div>
...
async function handleSave(status: string) {
  ...
  try {
    ...
    const invoice = await invoicesStore.create(payload)
